/* Localizações da equipe ao vivo — PROXY seguro para o mapa do CEO.
   O segredo (INTEG_KEY) e a URL do Worker Terra Pulse Brasil ficam em variáveis
   de ambiente do Cloudflare Pages — NUNCA no navegador.

   O front do Painel chama:  GET /api/localizacoes
   Esta função busca no Terra Pulse Brasil:  GET <SBS_BRASIL_URL>/api/integ/localizacoes?key=<INTEG_KEY>
