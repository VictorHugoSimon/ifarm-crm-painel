/* Indicadores do Painel do Vendedor (Terra Pulse Brasil) — PROXY seguro (contrato v2).
   Traz para a aba "Resultados das ações" os números da equipe de campo
   (carteira de clientes e PROSPECÇÃO) que vivem no sistema Terra Pulse Brasil:
   ...
   Busca no Terra Pulse Brasil (v2):
   ...
   - INTEG_KEY          a mesma chave secreta combinada com o Terra Pulse Brasil
