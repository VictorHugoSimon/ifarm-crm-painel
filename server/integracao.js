/* Integração Terra Pulse — barramento de dados entre os dois sistemas Terra Pulse
   (Painel Terra Pulse · Marketing/Gestão  ↔  Terra Pulse Brasil · Gestão Comercial),
   ...
   GET   /api/integracao?de=terra-pulse&tipo=vendas   -> lista registros (paginado)
        - de   : filtra pela ORIGEM ('painel-sbs' | 'terra-pulse'); omitido = todos
